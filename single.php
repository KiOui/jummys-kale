    ...
    <?php } ?>
        ...
        <div id="post-<?php the_ID(); ?>" <?php post_class('entry entry-post'); ?>>
            ...
            <div class="entry-footer">
                <div class="entry-meta">
                    <?php if($kale_posts_author_show == 1) { ?><div class="entry-author"><span><?php esc_html_e('Auteur: ', 'kale'); ?></span><span class="vcard author author_name"><span class="fn"><?php the_author_posts_link(); ?></span></span></div><?php } ?>
					<?php if($kale_posts_category_show == 1 && has_category()) { ?><div class="entry-category"><span><?php esc_html_e('Categorieën: ', 'kale'); ?></span><?php the_category(', '); ?></div><?php } ?>
